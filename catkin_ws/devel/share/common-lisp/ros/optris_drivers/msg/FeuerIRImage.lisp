...
(cl:defmethod cl:initialize-instance :after ((m <FeuerIRImage>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FeuerIRImage)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name optris_drivers-msg:<FeuerIRImage> is deprecated: use optris_drivers-msg:FeuerIRImage instead.")))

(cl:ensure-generic-function 'irimage-val :lambda-list '(m))
(cl:defmethod irimage-val ((m <FeuerIRImage>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader optris_drivers-msg:irimage-val is deprecated.  Use optris_drivers-msg:irimage instead.")
  (irimage m))

(cl:ensure-generic-function 'feuertime-val :lambda-list '(m))
(cl:defmethod feuertime-val ((m <FeuerIRImage>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader optris_drivers-msg:feuertime-val is deprecated.  Use optris_drivers-msg:feuertime instead.")
  (feuertime m))
