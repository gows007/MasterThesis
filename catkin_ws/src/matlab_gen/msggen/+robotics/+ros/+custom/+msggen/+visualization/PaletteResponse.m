classdef PaletteResponse < robotics.ros.Message
    %PaletteResponse MATLAB implementation of visualization/PaletteResponse
    ...
    properties (Constant)
        MessageType = 'visualization/PaletteResponse' % The ROS message type
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.visualization.PaletteResponse.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.visualization.PaletteResponse;
            obj.reload(strObj);
        end
    end
end
