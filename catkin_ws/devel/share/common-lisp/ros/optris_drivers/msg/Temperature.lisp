...
(cl:defmethod cl:initialize-instance :after ((m <Temperature>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Temperature)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name optris_drivers-msg:<Temperature> is deprecated: use optris_drivers-msg:Temperature instead.")))
...
(cl:defmethod temperature_flag-val ((m <Temperature>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader optris_drivers-msg:temperature_flag-val is deprecated.  Use optris_drivers-msg:temperature_flag instead.")
  (temperature_flag m))

(cl:ensure-generic-function 'temperature_box-val :lambda-list '(m))
(cl:defmethod temperature_box-val ((m <Temperature>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader optris_drivers-msg:temperature_box-val is deprecated.  Use optris_drivers-msg:temperature_box instead.")
  (temperature_box m))

(cl:ensure-generic-function 'temperature_chip-val :lambda-list '(m))
(cl:defmethod temperature_chip-val ((m <Temperature>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader optris_drivers-msg:temperature_chip-val is deprecated.  Use optris_drivers-msg:temperature_chip instead.")
  (temperature_chip m))
