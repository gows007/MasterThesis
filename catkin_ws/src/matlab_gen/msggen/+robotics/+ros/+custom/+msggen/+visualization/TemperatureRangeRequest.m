classdef TemperatureRangeRequest < robotics.ros.Message
    %TemperatureRangeRequest MATLAB implementation of visualization/TemperatureRangeRequest
    ...
    properties (Constant)
        MessageType = 'visualization/TemperatureRangeRequest' % The ROS message type
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.visualization.TemperatureRangeRequest.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.visualization.TemperatureRangeRequest;
            obj.reload(strObj);
        end
    end
end
