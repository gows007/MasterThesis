...
realVector = message.IQmsg.Data(1:1000*pulseWidth);
imagVector = message.IQmsg.Data((1000*pulseWidth+1):length(message.IQmsg.Data));
realData = reshape(realVector, 1000,pulseWidth);
imgData = reshape(imagVector, 1000,pulseWidth);
