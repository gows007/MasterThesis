...
(cl:defmethod cl:initialize-instance :after ((m <Palette-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Palette-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name optris_drivers-srv:<Palette-request> is deprecated: use optris_drivers-srv:Palette-request instead.")))

(cl:ensure-generic-function 'palette-val :lambda-list '(m))
(cl:defmethod palette-val ((m <Palette-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader optris_drivers-srv:palette-val is deprecated.  Use optris_drivers-srv:palette instead.")
  (palette m))

(cl:ensure-generic-function 'paletteScaling-val :lambda-list '(m))
(cl:defmethod paletteScaling-val ((m <Palette-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader optris_drivers-srv:paletteScaling-val is deprecated.  Use optris_drivers-srv:paletteScaling instead.")
  (paletteScaling m))

(cl:ensure-generic-function 'temperatureMin-val :lambda-list '(m))
(cl:defmethod temperatureMin-val ((m <Palette-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader optris_drivers-srv:temperatureMin-val is deprecated.  Use optris_drivers-srv:temperatureMin instead.")
  (temperatureMin m))

(cl:ensure-generic-function 'temperatureMax-val :lambda-list '(m))
(cl:defmethod temperatureMax-val ((m <Palette-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader optris_drivers-srv:temperatureMax-val is deprecated.  Use optris_drivers-srv:temperatureMax instead.")
  (temperatureMax m))
...
(cl:defmethod cl:initialize-instance :after ((m <Palette-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Palette-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name optris_drivers-srv:<Palette-response> is deprecated: use optris_drivers-srv:Palette-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <Palette-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader optris_drivers-srv:success-val is deprecated.  Use optris_drivers-srv:success instead.")
  (success m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Palette-response>)))
  ...
  "optris_drivers/PaletteResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Palette-response)))
  "Returns string type for a service object of type 'Palette-response"
  "optris_drivers/PaletteResponse")
