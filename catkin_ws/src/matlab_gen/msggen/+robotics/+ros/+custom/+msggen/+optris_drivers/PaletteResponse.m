classdef PaletteResponse < robotics.ros.Message
    %PaletteResponse MATLAB implementation of optris_drivers/PaletteResponse
    ...
    properties (Constant)
        MessageType = 'optris_drivers/PaletteResponse' % The ROS message type
    end
    ...
    methods
        function obj = PaletteResponse(msg)
            %PaletteResponse Construct the message object PaletteResponse
        ...
        function set.Success(obj, success)
            ...
            validateattributes(success, {'logical', 'numeric'}, {'nonempty', 'scalar'}, 'PaletteResponse', 'Success');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.optris_drivers.PaletteResponse.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.optris_drivers.PaletteResponse;
            obj.reload(strObj);
        end
    end
end
