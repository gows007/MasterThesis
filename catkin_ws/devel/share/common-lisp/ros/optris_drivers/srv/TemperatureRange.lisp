...
(cl:defmethod cl:initialize-instance :after ((m <TemperatureRange-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TemperatureRange-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name optris_drivers-srv:<TemperatureRange-request> is deprecated: use optris_drivers-srv:TemperatureRange-request instead.")))
...
(cl:defmethod temperatureRangeMin-val ((m <TemperatureRange-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader optris_drivers-srv:temperatureRangeMin-val is deprecated.  Use optris_drivers-srv:temperatureRangeMin instead.")
...
(cl:defmethod temperatureRangeMax-val ((m <TemperatureRange-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader optris_drivers-srv:temperatureRangeMax-val is deprecated.  Use optris_drivers-srv:temperatureRangeMax instead.")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<TemperatureRange-request>)))
  ...
  "optris_drivers/TemperatureRangeRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TemperatureRange-request)))
  "Returns string type for a service object of type 'TemperatureRange-request"
  "optris_drivers/TemperatureRangeRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <TemperatureRange-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TemperatureRange-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name optris_drivers-srv:<TemperatureRange-response> is deprecated: use optris_drivers-srv:TemperatureRange-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<TemperatureRange-response>)))
  ...
  "optris_drivers/TemperatureRangeResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TemperatureRange-response)))
  "Returns string type for a service object of type 'TemperatureRange-response"
  "optris_drivers/TemperatureRangeResponse")
