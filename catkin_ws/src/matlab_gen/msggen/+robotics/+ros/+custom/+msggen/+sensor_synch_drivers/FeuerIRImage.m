classdef FeuerIRImage < robotics.ros.Message
    %FeuerIRImage MATLAB implementation of sensor_synch_drivers/FeuerIRImage
    ...
    properties (Constant)
        MessageType = 'sensor_synch_drivers/FeuerIRImage' % The ROS message type
    end
    
    properties (Constant, Hidden)
        MD5Checksum = '4ca0c834ef4bb930d413675e62bb5f09' % The MD5 Checksum of the message definition
    end
    ...
    properties (Access = protected)
        Cache = struct('Header', [], 'Irimage', [], 'Feuertime', []) % The cache for fast data access
    end
    
    properties (Constant, Hidden)
        PropertyList = {'Feuertime', 'Header', 'Irimage'} % List of non-constant message properties
        ROSPropertyList = {'feuertime', 'header', 'irimage'} % List of non-constant ROS message properties
    end
    ...
    methods
        ...
        function set.Header(obj, header)
            ...
            validateattributes(header, {obj.StdMsgsHeaderClass}, {'nonempty', 'scalar'}, 'FeuerIRImage', 'Header');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.sensor_synch_drivers.FeuerIRImage.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.sensor_synch_drivers.FeuerIRImage;
            obj.reload(strObj);
        end
    end
end
