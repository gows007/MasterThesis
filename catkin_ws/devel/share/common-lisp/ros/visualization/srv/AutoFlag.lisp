...
(cl:defmethod cl:initialize-instance :after ((m <AutoFlag-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AutoFlag-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name visualization-srv:<AutoFlag-request> is deprecated: use visualization-srv:AutoFlag-request instead.")))

(cl:ensure-generic-function 'autoFlag-val :lambda-list '(m))
(cl:defmethod autoFlag-val ((m <AutoFlag-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader visualization-srv:autoFlag-val is deprecated.  Use visualization-srv:autoFlag instead.")
  (autoFlag m))
...
(cl:defmethod cl:initialize-instance :after ((m <AutoFlag-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AutoFlag-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name visualization-srv:<AutoFlag-response> is deprecated: use visualization-srv:AutoFlag-response instead.")))

(cl:ensure-generic-function 'isAutoFlagActive-val :lambda-list '(m))
(cl:defmethod isAutoFlagActive-val ((m <AutoFlag-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader visualization-srv:isAutoFlagActive-val is deprecated.  Use visualization-srv:isAutoFlagActive instead.")
  (isAutoFlagActive m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<AutoFlag-response>)))
  ...
  "visualization/AutoFlagResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'AutoFlag-response)))
  "Returns string type for a service object of type 'AutoFlag-response"
  "visualization/AutoFlagResponse")
