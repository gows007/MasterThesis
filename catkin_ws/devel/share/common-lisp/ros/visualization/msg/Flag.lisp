...
(cl:defmethod cl:initialize-instance :after ((m <Flag>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Flag)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name visualization-msg:<Flag> is deprecated: use visualization-msg:Flag instead.")))
...
(cl:defmethod flag_state-val ((m <Flag>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader visualization-msg:flag_state-val is deprecated.  Use visualization-msg:flag_state instead.")
  (flag_state m))
