classdef FeuerIRImage < robotics.ros.Message
    %FeuerIRImage MATLAB implementation of optris_drivers/FeuerIRImage
    ...
    properties (Constant)
        MessageType = 'optris_drivers/FeuerIRImage' % The ROS message type
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.optris_drivers.FeuerIRImage.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.optris_drivers.FeuerIRImage;
            obj.reload(strObj);
        end
    end
end
