...
if(NOT "include;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'radar_drivers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/feuerwerr/Repository/feuerwerr_ros/trunk/catkin_ws/install/${idir}'.  Ask the maintainer 'Bernhard Kleiner <Kleiner@todo.todo>' to fix it.")
    endif()
